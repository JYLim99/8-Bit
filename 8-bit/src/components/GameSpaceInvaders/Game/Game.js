...
class Game extends Component {
    ...
    animateAliens() {
        ...
        const maxLeft =
            this.state.settings.width - this.state.alien.movement.right;
        const maxTop =
    ...
    unidentifiedLaserBeams() {
        ...
        let posY =
            randomAlien.top +
            this.state.alien.height +
            this.state.alien.padding;
