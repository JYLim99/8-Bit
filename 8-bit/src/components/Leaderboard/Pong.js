...
function Pong() {
  ...
  //Function to fetch top three scores for Pong
  const fetchScores = async () => {
    const response = db.collection('pongScores')
  ...
  return (
    <Box display='flex' justifyContent='center' alignItems='center'>
      <TableContainer className={classes.container} component={Paper}>
        <Table className={classes.table} aria-label='Pong Leaderboard'>
